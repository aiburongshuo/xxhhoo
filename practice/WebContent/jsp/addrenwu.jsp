...
<%@page import="Sercive.Classervice"%>
<%@page import="Sercive.Isercive"%>
  ...
  <tr>
      <th class="tablestyle_title" >学员添加页面</th>
				...
				<legend>添加学员</legend>
					  ...
					  <tr>
					   ...
					   <tr>
					    ...
					    <td><input class="text" style="width:138px" type="text" size="40" name="age"></td>
					  </tr>
					  <tr>
		...
		<TR>
			...
			<input type="submit" name="Submit" value="保存" class="button" style="margin-left: 400px"/>　
			
			<input type="button" name="Submit2" value="返回" class="button"/><span style="color:red;">${mes}</span></TD>
		</TR>
		</TABLE>
